...
excerpt: "Kismet es un software de libre acceso que se puede utilizar como rastreador de redes para redes inalámbricas."
date: 2024-02-16
classes: wide
header:
  teaser: /assets/images/56/preview1.png
...
![](/assets/images/56/056.png)

##¿Qué es Kismet?

Kismet es un software de libre acceso que se puede utilizar como rastreador de redes para redes inalámbricas. El software recopila información sobre las WLAN disponibles, los puntos de acceso WLAN, los clientes WLAN y los canales de transmisión utilizados y se comporta de forma pasiva. También es posible registrar el tráfico de datos inalámbricos. Las grabaciones se pueden analizar con Wireshark, por ejemplo.
