...
excerpt: "En esta ocasión estaremos revisando la instalación de Squid proxy, una herramienta para el bloqueo de sitios web en la red local dentro de un sistema basado en RHEL."
date: 2022-09-02
classes: wide
header:
  teaser: /assets/images/27/preview1.png
...
Pueden encontrar más información sobre el proxy squid en: [http://www.squid-cache.org/](http://www.squid-cache.org/)
