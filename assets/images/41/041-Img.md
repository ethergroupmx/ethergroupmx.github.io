...
Slug: 041-Img
Summary: Recientemente se han descubierto dos vulnerabilidades en ImageMagick 7.1.0-49: un DoS (CVE-2022-44267) y un Information Disclosure (CVE-2022-44268). Nos vamos a centrar en esta última ya que creo que es bastante más interesante.
Tags: Vulnerabilidad
...
<img class="img-fluid" src="041.png" alt="Foto 1">
* * * * * 
...
<img class="img-fluid" src="042.png" alt="Foto 2">
