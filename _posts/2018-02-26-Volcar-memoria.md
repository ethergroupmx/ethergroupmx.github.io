...
excerpt: "Al trabajar con sistemas Windows, es importante saber que no todo son exploits, y con ello en mente es posible hacer uso de herramientas del propio sistema."
date: 2018-02-26
classes: wide
header:
   teaser: /assets/images/03/preview1.png
