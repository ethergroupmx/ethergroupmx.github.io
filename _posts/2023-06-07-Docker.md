---
layout: single
title: "Cheat sheet de Docker (Comandos mas utilizados)"
excerpt: "Docker es un sistema de contenedorización que empaqueta y ejecuta la aplicación con sus dependencias dentro de un contenedor."
date: 2023-06-07
classes: wide
header:
